...
public class DocumentDatabaseClient extends DatabaseClient implements IDocumentDatabaseClient {
	...
	/* (non-Javadoc)
	 * @see edu.asu.giles.files.impl.IDocumentDatabaeClient#addFile(edu.asu.giles.core.IDocument)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see edu.asu.giles.files.impl.IDocumentDatabaeClient#getFileById(java.lang.String)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see edu.asu.giles.files.impl.IDocumentDatabaeClient#getFileByUploadId(java.lang.String)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see edu.asu.giles.files.impl.IDocumentDatabaeClient#getFilesByExample(edu.asu.giles.core.IDocument)
	 */
	@Override
