...
public class ExceptionHandlingController {
	...
	public ResponseEntity<String> fileTooBig(Exception ex) {
		...
		return new ResponseEntity<String>("{\"error\": \"File upload limit exceeded.\"}", HttpStatus.PAYLOAD_TOO_LARGE);
	}
	...
	public ResponseEntity<String> handleHttpClient(RestClientResponseException e) {
		...
		return new ResponseEntity<String>(HttpStatus.valueOf(e.getRawStatusCode()));
	}
